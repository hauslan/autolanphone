...
const phones = fs.readFileSync('./phones.json', 'utf-8');
const map = JSON.parse(phones);

let doc = yaml.load(fs.readFileSync('./template.yaml', 'utf-8'));
...
fs.writeFileSync('ansible.yaml', yaml.dump(doc));